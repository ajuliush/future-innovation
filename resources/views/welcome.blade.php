...
<body class="antialiased">
    <div
        class="relative sm:center sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                                    ...
                                    @foreach ($files as $item)
                                        <td
                                            ...
                                            <a href="javascript:void(0)"
                                                class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed show"
                                                data-id="{{ $item->id }}">
